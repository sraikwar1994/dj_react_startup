        ...
        <>
            ...
            <nav className={isActive ? header_enable : header_disable}   data-navbar-on-scroll="data-navbar-on-scroll">
                ...
                <div className={isActive ? mobile_header_enable : mobile_header} id="navbarSupportedContent">
                    ...
                    <li className="nav-item px-3 px-xl-4"><a className="nav-link fw-medium" aria-current="page" href="/login">Login</a></li>
                    <li className="nav-item px-3 px-xl-4"><a className="btn btn-outline-dark order-1 order-lg-0 fw-medium" href="/signup">Sign Up</a></li>
